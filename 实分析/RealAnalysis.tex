...
这是因为有些集合不一定能完全分解为两个集合的积, 如下图所示:

\begin{figure}
    \centering
    \begin{tikzpicture}[domain=0:2,scale=1]
        \draw[thick,->] (0,0) -- (2+0.1,0) node[right] {};
        \draw[thick,->] (0,0) -- (0,2+0.1) node[above] {};
        \filldraw[red] (0.5,0.5)--(1.5,0.5)--(1.5,1.5)--(0.5,1.5)--cycle;
        \filldraw[red] (1,1)--(2,1)--(2,2)--(1,2)--cycle;
    \end{tikzpicture}
    \caption{一个不能直接分解为两个集合的积的集合}
\end{figure}
